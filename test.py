...
DATASETS = {
    ...
    "Sinoux": "dataset/sinoux/SiouxFalls_net.tntp",
...
with tab1:
    ...
    if node_count < 2 or edge_count == 0:
        ...
        st.warning(
            ...
            "Run Ford-Fulkerson to view the explored subgraph instead."
        )
    else:
    ...
    if st.button("Run Ford-Fulkerson"):
        if source == sink:
            ...
            st.download_button(
                ...
                file_name=f"ford_fulkerson_{dataset_name.lower()}_{source}_{sink}.json",
